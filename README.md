...
## Description
This app utilizes mainly Javascript to select a national park based on the State the user chooses. Once a user selects a state, the national parks of that state is presented to the user along with the park's details such as the park's name, daily operation hours, and directions.
